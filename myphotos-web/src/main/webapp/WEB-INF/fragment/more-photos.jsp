            ...
            <figcaption>
                <p class="author">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="/${photo.profileId.uid}" class="img"><img src="${photo.profileId.avatarUrl}" alt="${photo.profileId.fullName}"/></a>
                            <span class="name"><a href="/${photo.profileId.uid}">${photo.profileId.fullName}</a></span>
                        </c:otherwise>
                    </c:choose>
                </p>
                <p class="stat">
